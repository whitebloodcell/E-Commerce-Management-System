...
public class ReceptionLogInToRegisterController {
     ...
     */
    @PostMapping("/login")
    public ResponseEntity<UserDto>login(HttpSession session, String userAccount, String userPassword) throws DaoException {

        UserDto userDto =logInToRegisterService.Login(userAccount, userPassword);
